...
export const HEADER_AUTH_TOKEN_KEY = 'beevo-auth-token';
export const IMAGE_RESOLUTIONS = [1000, 800, 600, 400];
export const HOMEPAGE_IMAGE = '/homepage.webp';
export const DEFAULT_METADATA_URL = 'https://demo.beevo/';
...
export const DEV_API = ENV_VARIABLES.VITE_VENDURE_DEV_URL || 'https://demo.beevo';
export const PROD_API = ENV_VARIABLES.VITE_VENDURE_PROD_URL || 'https://demo.beevo';
